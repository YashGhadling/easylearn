 ...
 * Generated at: 2024-09-02 15:36:17 UTC
...
public final class login_005fprocess_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    String jdbcUrl = "jdbc:mysql://localhost:3306/easyleran"; // Replace 'yourdatabase' with your actual database name
    String jdbcUsername = "root"; // Replace with your database username
    String jdbcPassword = ""; // Replace with your database password

    // Retrieve the parameters from the login form
    ...
    try {
        ...
        // SQL query to select user based on username and hashed password
        ...
        if (rs.next()) {
            // Set the username in session and redirect to index.jsp
